...
form.addEventListener('submit', function (e) {
    ...
    if(BMI>30.0){
        ...
        tipe = "normal"; // normal
        text = "Normal (ideal)";
    } else if (BMI>=1 && BMI<=18.4){ // 18.4 (kurang dari 18.5)
